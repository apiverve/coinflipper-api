# Coin Flipper API - Examples

This folder contains example code for using the Coin Flipper API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/coinflipper',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/coinflipper");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/coinflipper](https://docs.apiverve.com/ref/coinflipper)
