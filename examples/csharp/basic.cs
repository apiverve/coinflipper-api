    ...
    class CoinFlipperExample
    {
        ...
        static async Task<JsonDocument> CallCoinFlipperAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;flips&quot;] &#x3D; 10 };
        ...
        {
            Console.WriteLine("📤 Calling Coin Flipper API...\n");

            var result = await CallCoinFlipperAPI();
