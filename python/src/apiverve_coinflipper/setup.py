...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/coinflipper',
        'Source': 'https://github.com/apiverve/coinflipper-api',
        'Bug Tracker': 'https://github.com/apiverve/coinflipper-api/issues'
    },
    classifiers=[
