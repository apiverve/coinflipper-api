...
const (
	baseURL        = "https://api.apiverve.com/v1/coinflipper"
	defaultTimeout = 30 * time.Second
)

// Client is the Coin Flipper API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Coin Flipper API client.
...
// Execute makes a request to the Coin Flipper API with typed parameters.
//
