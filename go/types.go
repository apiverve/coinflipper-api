// Package coinflipper provides a Go client for the Coin Flipper API.
//
// For more information, visit: https://apiverve.com/marketplace/coinflipper?utm_source=go&utm_medium=readme
package coinflipper
...
// Request contains the parameters for the Coin Flipper API.
//
// Parameters:
//   - flips: integer - Number of coins to flip [min: 1, max: 10000]
type Request struct {
	Flips int `json:"flips,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"flips": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(10000)},
	}
...
// ResponseData contains the data returned by the Coin Flipper API.
type ResponseData struct {
	TotalFlips int `json:"total_flips"`
	Flips []string `json:"flips"`
	HeadsCount int `json:"heads_count"`
	TailsCount int `json:"tails_count"`
	HeadsPercentage int `json:"heads_percentage"`
	TailsPercentage int `json:"tails_percentage"`
	LongestStreak LongestStreakData `json:"longest_streak"`
	FirstFlip string `json:"first_flip"`
	LastFlip string `json:"last_flip"`
	IsFair bool `json:"is_fair"`
}

// LongestStreakData represents the longest_streak object.
