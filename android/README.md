...
```gradle
dependencies {
    implementation 'com.github.apiverve:coinflipper-api:1.1.13'
}
```
...
```java
import com.apiverve.coinflipper.CoinFlipperAPIClient;
import com.apiverve.coinflipper.APIResponse;
import com.apiverve.coinflipper.APIException;

// Initialize the client
CoinFlipperAPIClient client = new CoinFlipperAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("flips", 1);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/coinflipper](https://docs.apiverve.com/ref/coinflipper)
...
- **Documentation:** [https://docs.apiverve.com/ref/coinflipper](https://docs.apiverve.com/ref/coinflipper)
- **Issues:** [GitHub Issues](https://github.com/apiverve/coinflipper-api/issues)
