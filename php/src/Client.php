...
namespace APIVerve\Coinflipper;
...
/**
 * Client for the Coin Flipper API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/coinflipper?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/coinflipper';
    ...
    private const VALIDATION_RULES = [
        'flips' => ['type' => 'integer', 'required' => false, 'min' => 1, 'max' => 10000]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CoinflipperClient] {$message}\n";
        }
    }
}
