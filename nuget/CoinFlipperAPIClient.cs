...
namespace APIVerve.API.CoinFlipper
{
    ...
    /// <summary>
    /// Client for the CoinFlipper API
    /// </summary>
    public class CoinFlipperAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/coinflipper";
        ...
        {
            { "flips", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 10000 } }
        };
        ...
        public CoinFlipperAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CoinFlipperAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CoinFlipperAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CoinFlipperQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CoinFlipperQueryOptions options)
        {
        ...
        public ResponseObj Execute(CoinFlipperQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CoinFlipperQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CoinFlipperQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CoinFlipperQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CoinFlipperQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CoinFlipperQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CoinFlipperQueryOptions options)
        {
