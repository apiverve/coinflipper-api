...
class coinflipperWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/coinflipper');
        }
        ...
        this.validationRules = {"flips":{"type":"integer","required":false,"min":1,"max":10000,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/coinflipper`);
        }
    }
...
module.exports = coinflipperWrapper;
